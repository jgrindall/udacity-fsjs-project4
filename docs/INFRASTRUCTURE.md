Infrastructure: What services (from AWS) your project needs to run?

    There are 3 services you need to list from AWS, and also add CircleCI since that is needed for the pipeline infrastructure
